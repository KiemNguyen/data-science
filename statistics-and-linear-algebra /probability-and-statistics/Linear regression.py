...
y = -2 * x
plt.plot(x, y)
plt.show()# The wine quality data is loaded into wine_quality
...
squared_residuals = (wine_quality["quality"] - predicted_y) ** 2
...
def within_percentage(y, predicted_y, standard_error, error_count):
  within = standard_error * error_count
